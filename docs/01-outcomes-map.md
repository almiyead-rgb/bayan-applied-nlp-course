...
| 3 | Fine-tuning للتصنيف وNER وQA | يوم 2: M3 | baseline ثم نموذج BERT-family؛ label alignment؛ null answer | classifier + NER + QA pipeline | metrics صحيحة + اختبارات alignment/no-answer |
