...
| 2 | شرح الانتباه والمحولات | يوم 1: M2 | حساب attention صغير، تتبع shapes، ثم forward pass فعلي وعدّ المعاملات وقراءة رؤوس attention | notebook يشرح forward pass | asserts عددية + تفسير خريطة attention وحدودها |
...
|---|---|---|
| 🟢 أساسي | خلايا TODO المحددة، البيانات المصغرة، نموذج صغير، retrieve ثم re-rank مقاس، وتقارير القالب | جميع الأدلة الإلزامية تعمل وتُشرح |
